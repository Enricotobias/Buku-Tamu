@extends('layout.pages.pameran')

@section('konten')
    <!-- START FORM -->
    <div class="container mt-4">
        <form class="bg-light p-4 rounded" action="{{ url('nonmember_pameran') }}" method="POST">
            @csrf
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-10">
                    <input type="text" id="disabledTextInput" class="form-control" name="event_id" placeholder="Pameran" value='2' readonly>
                </div>
            </div>
            <div class="form-group row mb-4">
